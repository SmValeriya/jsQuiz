...
/***/ "./src/scripts/common/timeLine.js":
/*!****************************************!*\
  !*** ./src/scripts/common/timeLine.js ***!
  \****************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "startTimeLine": function() { return /* binding */ startTimeLine; },
/* harmony export */   "stopTimeLine": function() { return /* binding */ stopTimeLine; }
/* harmony export */ });
...
function startTimeLine() {
  ...
  counter = setInterval(() => {
    ++timeValue;
    if (timeValue > _index_js__WEBPACK_IMPORTED_MODULE_0__.initialTime * 100) {
      stopTimeLine();
      return;
    }
...
function frame(time) {
  timeLine.style.width = (time * timeLineWidth) / _index_js__WEBPACK_IMPORTED_MODULE_0__.initialTime / 100 + 'px';
}
...
/* harmony import */ var _common_timeLine_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./common/timeLine.js */ "./src/scripts/common/timeLine.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  infoBox.addEventListener('click', function (e) {
    ...
    if (e.target.closest('.info__btn-start')) {
      ...
      (0,_common_timeLine_js__WEBPACK_IMPORTED_MODULE_5__.startTimeLine)();
    }
  });
  ...
  quizBox.addEventListener('click', function (e) {
    if (
      ...
      (0,_common_timeLine_js__WEBPACK_IMPORTED_MODULE_5__.stopTimeLine)();
